...
const Header = () => {
  ...
  const adminEmails = ["mueezimran1@gmail.com", "sparklingtreasure451@gmail.com"];

  return (
    <>
      <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#cac3e2] bg-[#cac3e2] px-4 md:px-10 py-3 relative">
        <div className="flex items-center gap-4 md:gap-8">
          <Link to="/" className="flex items-center gap-2 md:gap-4 text-[#141414]">
            <h2 className="text-[#141414] text-lg font-bold leading-tight tracking-[-0.015em]">Sparkaling Treasure</h2>
          </Link>
...
#cac3e2] items-center justify-center pl-4 rounded-l-lg border-r-0">
...
#cac3e2] focus:border-none h-full placeholder:text-neutral-500 px-4 rounded-l-none border-l-0 pl-2 text-base font-normal leading-normal"
                value={searchQuery}
...
#cac3e2] text-[#141414] hover:bg-[#FFDCDC] transition">🛒 Cart</button>
            {user ? (
              <>
                <button onClick={handleLogout} className="px-4 h-10 rounded-lg bg-[#
#cac3e2] text-[#141414] text-sm font-semibold hover:bg-[#
#cac3e2] transition">Logout</button>
...
#cac3e2] text-white text-sm font-semibold hover:opacity-90 transition"
              >
...
#cac3e2]">
        ...
        {isMenuOpen && (
          <div className="md:hidden absolute top-full left-0 right-0 bg-white shadow-lg z-50 border-t border-[#cac3e2]">
